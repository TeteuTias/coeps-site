            ...
            <div className="inscricoes-contact">
                ...
                <div className="contact-row">
                    ...
                    <div className="contact-item">
                        ...
                        <Link href="https://api.whatsapp.com/send?phone=5562983306426&text=Olá,%20quero%20falar%20sobre%20o%20COEPS!" prefetch={false} target="_blank"><span>+55 34 99120-9359</span></Link>
                            </div>
                    <div className="contact-item">
